...
public:
	...
	//--CHANGE
	void reset() override;
	//Sets info tag for pieces based on color
	//return if successfully worked (IE: VALID CUBE)
	//		Return error not fully implemented (works on valid cubes, does not fully detect invalid ones
	bool assignPieceInfo();
